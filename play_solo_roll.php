...
if (isset($_POST['case'])) {
    $case = $_POST['case'];
    $caseimg = $case . "_Case.png";
    $sql = "SELECT * FROM masteritem WHERE collection = '$case'";
    $query = $conn->query($sql);
    $conn->close();
    $prices = array();
    while ($record = $query->fetch_assoc()) {
    ...
    <div class="container">
        <div class="price p-4 row justify-content-center align-items-center">
            ...
            <div class="text-center">
                <img id="skin" class="border <?php echo $border[$rarity]; ?>" src="image/skins/Cases/<?php echo $case . '/' . $caseimg; ?>">
            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="play_solo.php"><button type="button" class="btn btn-warning" data-bs-dismiss="modal">Open more</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
